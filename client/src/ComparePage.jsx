        ...
        <div className="min-h-screen bg-gradient-to-br from-purple-50 via-blue-50 to-indigo-100">
            ...
            <header className="container mx-auto px-4 py-4 md:py-6">
                <nav className="flex items-center justify-between">
                    ...
                    >
                        ...
                        <span className="text-lg md:text-xl font-bold text-gray-900">SpeedX</span>
                    </div>
                ...
                {isMobileMenuOpen && (
                    <div className="md:hidden mt-4 py-4 border-t border-gray-200">
                        <div className="flex flex-col space-y-4">
                            ...
                            <button className="w-full px-4 py-3 border border-gray-300 rounded-lg text-gray-600 hover:text-gray-900 transition-colors text-center">
                                Contact
                            </button>
            ...
            <main className="container mx-auto px-4 py-6 md:py-8">
                ...
                <div className="text-center mb-8 md:mb-12">
                    <div className="inline-flex items-center px-3 py-1 rounded-full bg-purple-100 text-purple-800 text-xs md:text-sm font-medium mb-4 md:mb-6">
                        ...
                        <span className="hidden sm:inline">Website Performance Comparison</span>
                        <span className="sm:hidden">Performance Compare</span>
                    </div>
                        ...
                        <div className="p-4 md:p-8">
                            <div className="text-center mb-6 md:mb-8">
                                <div className="flex items-center justify-center mb-3 md:mb-4">
                                    <svg className="h-5 w-5 md:h-6 md:w-6 text-purple-600 mr-2 md:mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9" />
                                    </svg>
                                    <h2 className="text-lg md:text-2xl font-bold text-gray-900">Add Websites to Compare</h2>
                                </div>
                                <p className="text-sm md:text-base text-gray-600 px-2">Enter 2-3 website URLs to compare their performance metrics</p>
                            </div>
                                        ...
                                        <div className="block md:hidden space-y-2">
                                            ...
                                            <div className="relative">
                                                <input
                                                    ...
                                                    className={`w-full p-3 text-base border-2 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 transition-all duration-200 ${website.url === ''
                            ...
                            <div className="p-6">
                                ...
                                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4">
                                    ...
                                    <button
                                        ...
                                        className="flex items-center justify-center px-3 md:px-4 py-3 bg-blue-500 hover:bg-blue-600 text-white rounded-lg transition-colors duration-200 text-sm md:text-base"
                                    >
                                    ...
                                    <button
                                        ...
                                        className="flex items-center justify-center px-3 md:px-4 py-3 bg-green-500 hover:bg-green-600 text-white rounded-lg transition-colors duration-200 text-sm md:text-base"
                                    >
                                        <svg className="h-4 w-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <button
                                        onClick={exportToCSV}
                                        className="flex items-center justify-center px-3 md:px-4 py-3 bg-purple-500 hover:bg-purple-600 text-white rounded-lg transition-colors duration-200 text-sm md:text-base"
                                    >
                                        <svg className="h-4 w-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    ...
                                    <button
                                        ...
                                        className="flex items-center justify-center px-3 md:px-4 py-3 bg-gray-600 hover:bg-gray-700 text-white rounded-lg transition-colors duration-200 text-sm md:text-base"
                                    >
                                        <svg className="h-4 w-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
